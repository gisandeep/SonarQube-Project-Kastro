pipeline {
    ...
    environment {
        ...
        DOCKERHUB_USERNAME = 'gsandeep8367'  // Set this directly to your Docker Hub username
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/gisandeep/SonarQube-Project-Kastro.git'
            }
        }
